...
class PurchaseOrder(models.Model):
    ...
    mrx_so_bill_ids = fields.Many2many('account.move', 'purchase_order_sale_order_bill_rel', 'purchase_order_id', 'account_move_id', compute='_compute_so_bill_ids', readonly=True, store=True)
